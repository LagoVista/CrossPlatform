...
namespace SeaWolf.ViewModels
{
    public class SettingsViewModel : AppViewModelBase
    {
        ...
        public SettingsViewModel()
        {
            ...
            {
                new MenuItem() {FontIconKey = "fa-gear", Name = "Add New Boat", Command =  new RelayCommand(() => ViewModelNavigation.NavigateAsync<ConnectHardwareViewModel>(this)), Help="Add a new boar with SeaWolf Marine" },
                new MenuItem() {FontIconKey = "fa-gear", Name = "Boats", Command =  new RelayCommand(() => ViewModelNavigation.NavigateAsync<ProvisionDeviceViewModel>(this)), Help="My Boats" },
                new MenuItem() {FontIconKey = "fa-gear", Name = "About", Command =  new RelayCommand(() => ViewModelNavigation.NavigateAsync<ProvisionDeviceViewModel>(this)), Help="My Boats" },
