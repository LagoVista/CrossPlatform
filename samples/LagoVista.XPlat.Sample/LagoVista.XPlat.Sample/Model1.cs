...
namespace LagoVista.XPlat.Sample
{
    ...
    [EntityDescription("Sample Data", Resources.SampleResources.Names.Model1_Title, Resources.SampleResources.Names.Model1_Help, Resources.SampleResources.Names.Model1_Description, EntityDescriptionAttribute.EntityTypes.SimpleModel, typeof(Resources.SampleResources))]
    public class Model1
    {
        ...
        [FormField(LabelResource: Resources.SampleResources.Names.Model1_DropDown, FieldType: FieldTypes.Picker, EnumType:typeof(DropDown1Options), WaterMark:Resources.SampleResources.Names.Model1_DropDown_Select, ResourceType: typeof(Resources.SampleResources))]
        public EntityHeader DropDownBox1 { get; set; }

        [FormField(LabelResource: Resources.SampleResources.Names.Model1_CheckBox, FieldType: FieldTypes.CheckBox, ResourceType:typeof(Resources.SampleResources))]
